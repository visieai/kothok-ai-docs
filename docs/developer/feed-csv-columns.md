...
## How price and sale price map

If a row has both a normal price and a sale price, the two become the ends of the
price range. A product at 3000 with a sale price of 1500 is stored as a range of
1500 to 3000. Set your price columns with that in mind so products match the budget
searches you expect.
