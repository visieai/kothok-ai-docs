...
!!! note "How a feed refreshes"
    A feed is read when a sync runs, started from the dashboard. If prices change
    often, use Push, which updates the moment you call it.
